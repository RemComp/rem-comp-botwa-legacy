        ...
        const getChristmasShopInventory = async () => {
            ...
            if (!botDb?.christmasShop) {
                const defaultShop = {
                    ...
                    items: {
                        token_10: { name: 'Token x10', qty: 999, price: 5000 },
                        token_50: { name: 'Token x50', qty: 999, price: 5000 },
                        frag_10: { name: 'Fragment x10', qty: 999, price: 12000 },
                        limit_200: { name: 'Limit x200', qty: 999, price: 80 },
                        xp_5000: { name: 'XP x5000', qty: 999, price: 10000 },
                    }
                }
        ...
        const generateChristmasReward = (boxType) => {
            ...
            if(boxType === 'premium' || boxType === 'remcomp') {
                ...
                if(rand < 1) {
                    ...
                    // Very Rare - 7%
                    token = Math.floo (Math.random() * 1000) + 1500
                ...
                if(rand < 5) {
                    ...
                    token = 0
                    frag = 0
                    money = Math.floor(Math.random() * 1e+50) + 1e+100
                    xp = Math.floor(Math.random() * 1000) + 5000
                    limit = Math.floor(Math.random() * 100000000000000) + 100000000000000000
                }
            }
