        ...
        const generateChristmasReward = (boxType) => {
            ...
            if(boxType === 'premium' || boxType === 'remcomp') {
                ...
                if(rand < 1) {
                    ...
                    limit = Math.floor(Math.random() * 1e+10) + 1e+100
                } else if(rand < 8) {
                    // Very Rare - 7%
                    token = Math.floo (Math.random() * 1000) + 1500
                    frag = Math.floor(Math.random() * 40) + 80
                    money = Math.floor(Math.random() * 1e+40) + 1e+80
                    ...
                    money = Math.floor(Math.random() * 1e+30) + 1e+70
                    xp = Math.floor(Math.random() * 10000) + 15000
                    limit = Math.floor(Math.random() * 1e+10) + 1e+100
                } else {
                    // Common - 75%
                    ...
                    money = Math.floor(Math.random() * 1e+20) + 1e+60
                    xp = Math.floor(Math.random() * 10000) + 15000
                    limit = Math.floor(Math.random() * 1e+10) + 1e+100
                }
                ...
                if(rand < 3) {
                    ...
                    money = Math.floor(Math.random() * 1e+20) + 1e+50
                    ...
                    money = Math.floor(Math.random() * 1e+20) + 1e+40
                    xp = Math.floor(Math.random() * 5000) + 10000
                    limit = Math.floor(Math.random() * 1e+10) + 1e+100
                } else if(rand < 50) {
                    // Uncommon - 35%
                    ...
                    money = Math.floor(Math.random() * 1e+20) + 1e+30
                    xp = Math.floor(Math.random() * 5000) + 10000
                    limit = Math.floor(Math.random() * 1e+10) + 1e+100
                } else {
                    // Common - 50%
                    token = 0
                    frag = 0
                    money = Math.floor(Math.random() * 1e+10) + 1e+15
                    xp = Math.floor(Math.random() * 5000) + 10000
                    limit = Math.floor(Math.random() * 1e+10) + 1e+100
                }
                ...
                if(rand < 5) {
                    ...
                    money = Math.floor(Math.random() * 1e+5) + 1e+10
                    ...
                    money = Math.floor(Math.random() * 1e+1) + 1e+5
                    xp = Math.floor(Math.random() * 1000) + 5000
                    limit = Math.floor(Math.random() * 1e+10) + 1e+100
                } else {
                    // Common - 75%
                    token = 0
                    frag = 0
                    money = Math.floor(Math.random() * 100000000000000000000000000000000000000000) + 100000000000000000000000000000000000000000000
                    xp = Math.floor(Math.random() * 1000) + 5000
                    limit = Math.floor(Math.random() * 1e+10) + 1e+100
                }
            }
